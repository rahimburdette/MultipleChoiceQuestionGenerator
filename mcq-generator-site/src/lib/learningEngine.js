 ...
 */
export function buildReviewPrompt(dueLOs) {
  if (!dueLOs.length) return '';
  return '\n\n--- SPACED REPETITION REVIEW ---\nThe following learning objectives were previously missed and are due for review. Please include questions testing these specific LOs:\n\n' +
    dueLOs.map((lo) => `- [${lo.lecture}] ${lo.lo}`).join('\n');
}
