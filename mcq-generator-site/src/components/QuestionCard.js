      ...
      <div style={{ padding: '20px 24px' }}>
        ...
        <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {q.is_review && (
              <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[11px] font-semibold" style={{ color: '#3b82f6', background: '#eff6ff', border: '1px solid #bfdbfe' }}>
                ↻ Review
              </span>
            )}
          </div>
        ...
        {q.image_description && (
          <div className="mb-4 p-4 rounded-lg bg-indigo-50" style={{ border: '1px solid #c7d2fe' }}>
            <p className="text-[11px] font-bold text-indigo-500 uppercase tracking-wider mb-2">
              This question references a clinical image
            </p>
            <p className="text-[13px] text-gray-700 leading-relaxed italic">
              {q.image_description}
            </p>
            <p className="text-[11px] text-gray-400 mt-2">
              Read the description and visualize the finding before answering.
            </p>
          </div>
        )}
